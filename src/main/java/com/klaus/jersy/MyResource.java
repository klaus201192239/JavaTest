...
public class MyResource {
	...
	public String getResourceName(@PathParam("sub_path") String resourceName,
			@DefaultValue("Just a test!") @QueryParam("desc") String description, @Context Request request,
			@Context UriInfo uriInfo, @Context HttpHeaders httpHeader) {
	...
	public static void main(String[] args) {
		...
		ResourceConfig rc = new PackagesResourceConfig("com.klaus.jersy");
		try {
